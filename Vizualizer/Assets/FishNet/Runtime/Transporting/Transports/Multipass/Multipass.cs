...
//        /// </summary>
//        [HideInInspector]
//        public Transport ClientTransport { get; private set; }
//        #endregion
...
//        /// </summary>
//        private Dictionary<int, TransportIdData> _fromTransportIds = new Dictionary<int, TransportIdData>();
//        /// <summary>
//        /// Key is the Multipass connectionId, Value is the transport connectionId.
//        /// </summary>
//        private Dictionary<int, int> _toTransportIds = new Dictionary<int, int>();
//        /// <summary>
...
//        /// </summary>
//        private void TryClearClientIds(bool force)
//        {
...
//            _fromTransportIds.Clear();
//            _toTransportIds.Clear();
//            _availableIds.Clear();
//        }
...
//        /// </summary>
//        private bool GetMultipassId(int transportId, out int multipassId)
//        {
//            TransportIdData data;
//            if (!_fromTransportIds.TryGetValueIL2CPP(transportId, out data))
//            {
//                multipassId = -1;
//                //Fall through.
//                if (base.NetworkManager.CanLog(LoggingType.Error))
//                    Debug.LogError($"Multipass connectionId could not be found for transport connectionId of {transportId}.");
                
//                return false;
//            }

//            multipassId = data.MultipassId;
//            return true;
//        }
...
//        {
//            if (!_fromTransportIds.TryGetValueIL2CPP(multipassId, out data))
//            {
//                //Fall through.
//                if (base.NetworkManager.CanLog(LoggingType.Error))
...
//        /// <summary>
//        /// Gets the IP address of a remote connection Id for the first transport.
//        /// </summary>
...
//        }
//        /// <summary>
//        /// Gets the IP address of a remote connection Id for the transport on index.
//        /// </summary>
//        [MethodImpl(MethodImplOptions.AggressiveInlining)]
//        public string GetConnectionAddress(int connectionId, int index)
//        {
//            if (!IndexInRange(index, true))
//                return string.Empty;

//            return _transports[index].GetConnectionAddress(connectionId);
//        }
//        /// <summary>
...
//        {
//            return GetConnectionState(server, 0);
//        }
//        /// <summary>
...
//                _toTransportIds[multipassId] = connectionStateArgs.TransportIndex;
//                _fromTransportIds[transportConnectionId] = new TransportIdData(multipassId, connectionStateArgs.TransportIndex);
//            }
//            //Stopped.
//            else
//            {
//                if (!GetMultipassId(transportConnectionId, out multipassId))
//                    return;

//                _toTransportIds.Remove(multipassId);
//                _fromTransportIds.Remove(transportConnectionId);
//            }
...
//        {
//            int multipassId;
//            if (!GetMultipassId(receivedDataArgs.ConnectionId, out multipassId))
//                return;
...
//        /// <param name="index"></param>
//        /// <returns></returns>
//        public Transport GetClientTransport(int index)
//        {
//            if (!IndexInRange(index, true))
//                return null;
...
//        /// <param name="index"></param>
//        /// <returns></returns>
//        public Transport GetClientTransport<T>()
//        {
//            foreach (Transport t in Transports)
//            {
...
//        /// <returns></returns>
//        [MethodImpl(MethodImplOptions.AggressiveInlining)]
//        public int GetMaximumClients(int index)
//        {
//            if (!IndexInRange(index, true))
//                return -1;

//            return _transports[index].GetMaximumClients();
//        }
//        /// <summary>
...
//        /// </summary>
//        /// <param name="value"></param>
//        public void SetMaximumClients(int value, int index)
//        {
//            if (!IndexInRange(index, true))
//                return;

//            _transports[index].SetMaximumClients(value);
//        }
//        /// <summary>
...
//        {
//            SetServerBindAddress(address, 0);
//        }
//        /// Sets which address the server will bind to.
...
//        {
//            return StartConnection(server, 0);
//        }
...
//        {
//            return StopConnection(server, 0);
//        }
//        /// <summary>
